// Vendored from GitHub Context (bb-plugin-gh-context/components/github-favicon-icon.tsx),
// which vendored it from bb (MIT): apps/app/src/components/pull-request/GithubFaviconIcon.tsx.
// The GitHub mark with bb's check-status dot, so a row draws the same glyph as the banner.
