// Adapted from the sweeps' shared start-thread dialog. A row here is not tied
// to one repository, so the project is optional and the card names the row's
// source instead of a pull request number.
...
export type StartThreadSeed = {
  /** Null leaves the composer on its own default project. */
