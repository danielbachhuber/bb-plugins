// The sources' own marks, so a row says where it came from at a glance. The
// paths are Simple Icons' (https://simpleicons.org, CC0), in each brand's
// color, except GitHub's, which follows the text color so it reads in the
// dark theme.
import { cn } from "@/lib/utils";

export type Brand = "todoist" | "gmail" | "github";

const MARKS: Record<Brand, { title: string; path: string; className: string }> = {
  todoist: {
    title: "Todoist",
