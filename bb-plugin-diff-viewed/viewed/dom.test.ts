...
/**
 * The changes-panel toolbar as bb renders it above the file cards. This plugin
 * reads none of its controls; it only needs to recognise the row, because that
 * is how it knows the panel is open.
 */
