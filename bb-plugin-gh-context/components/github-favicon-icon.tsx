// Vendored from bb (MIT): apps/app/src/components/pull-request/GithubFaviconIcon.tsx.
// The GitHub mark with bb's check-status dot, so the banner draws the same glyph.
