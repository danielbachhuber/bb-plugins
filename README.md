...
| `bb-plugin-tokenomics` | `tokenomics` | Graphs how many tokens your threads used over the past day, three days, or week, lists each thread's share, and shows each thread's total in its header. |
